// Payment Canal component definition
...
const PaymentCanal = ({}) => {
  ...
  const [paymentOptions, setpaymentOptions] = React.useState([
    { title: "Orange Money", link: "/consumption/currency" },
    { title: "Unités", link: "/consumption/group-list" },
  ]);
  ...
  const handleClick = (event, canal) => {
    ...
    const custParams = {
      ...customerParams,
      canal: canal,
      currency: canal === "Orange Money" ? "" : canal,
    };
